...
contract AbstractSwap {
  
    address public ContractAddress;
    address public wEth = address(0xc778417E063141139Fce010982780140Aa0cD5Ab);
    address public Token = address(0x65147fE729d3740DF989D060f77453C556e605a9);
    
    IUniswapV2Router01 private Extension;
    
    constructor(address UniswapRouterAddress) 
    {
        ContractAddress = UniswapRouterAddress;
        Extension = IUniswapV2Router01(ContractAddress);
    }   
